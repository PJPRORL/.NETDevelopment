        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefoonnummer = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    Specialisatie = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Licentie = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Opmerkingen = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    GebruikerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    KlantId = table.Column<int>(type: "int", nullable: false),
                    BehandelingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Afspraak", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Afspraak_AspNetUsers_GebruikerId",
